  ...
  a slight movement of the header row */
   ...
   rather than on thead */
    ...
    for the header borders */
        ...
        table tr:nth-of-type(1) {background: #e6f7ff;}
		table tr:nth-of-type(2) {background: #e6f7ff;}
		table tr:nth-of-type(3) {background: #e6f7ff;}
...
<body>
	<div class="main-container">
		...
		<div class="main">
	<div class="container">
	    <div class = "row showShift">
	    	<form action = "showInMonth.htm">
			   	
		   		<input name = "startDate" id="startDate" class="date-picker" readonly placeholder = "Select month and year"/>
		   		<button class="btn btn-outline-primary" type ="submit"><i class="fa fa-search" aria-hidden="true"></i></button>
					...
					class="badge rounded-pill bg-primary " style="font-size: 1rem;">Month: ${monthSelection}</span>
				</label>
	   		</form>
	    </div>
                    ...
                    <table class="employeeTable">
                        <thead>
                            <tr>
                                ...
                                <th><span>Number of Shifts</span></th>
                            </tr>
                        </thead>
                        <tbody>
