	...
	<section class = "Form my-4 mx-5">
		<div class="container">
			<div class="row no-gutters">
				<div class="col-lg-5">
					<img src = "./images/teamilk.jpg" class = "img-fluid" alt = "" width = "347px" height = "200px" style = "position:relative; right:12px;">
				</div>
				...
				<div class="col-lg-7 px-5 pt-5">
					...
					<form action = "CheckLogin.htm" method = "post">
						...
						<div class="form-row">
							<div class="col-lg-7">
								<input name = "password" type = "password" placeholder = "Password" class = "form-control my-3 p-2">
							</div>
						</div>
						<div class="form-row">
							<div class="col-lg-7">
